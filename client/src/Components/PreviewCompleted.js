		...
		return (
			<div className="row  my-3">
				<Card className="col-s-11 col-md-10 mx-auto">
					<CardTitle>
						<div className="float-left ml-4 my-2">
							Your creARTtion!
						</div>
					</CardTitle>
					<CardImg
					...
					<CardBody className="col-12">
						<div className="row ">
							<div className="col-s-12 col-m-3 mx-auto mt-1 ">
								<Link to="/select">
									<Button color="primary btn-lg active ">
										<i
											className=" fa fa-arrow-left fa-lg text-white"
											aria-hidden="true"
										/>Go Back
									</Button>
								</Link>
							...
							<div className="col-s-12 col-m-3 mx-auto mt-1">
								<Button color="primary btn-lg active ">
									Download<i
										className="fa fa-floppy-o fa-lg text-white"
										aria-hidden="true"
									/>
								</Button>
							</div>
							<div className="col-s-12 col-m-3 mx-auto mt-1">
								<Link to="/gallery">
									<Button color="primary btn-lg active ">
										Save<i
											className="fa fa-cloud-upload fa-lg text-white"
											aria-hidden="true"
										/>
									</Button>
								</Link>
